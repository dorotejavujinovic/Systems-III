...
function HomeSection({
    lightBg, topLine, lightText, headline, buttonLabel, description, img, alt, imgStart, lightTextDesc
}) {
    return (<>
    <Navbar />
    ...
    >
     <div className="container">
         ...
         style={{display: 'flex', msFlexDirection: imgStart === 'start' ? 'row-reverse' : 'row'}}
         >
             <div className="col">
